          ...
          <View style={s.heroInfo}>
            {trainer.featuredTrainer && (
              <View style={s.featuredBadge}>
                <Text style={s.featuredText}>PRO COACH</Text>
              </View>
            )}
                    ...
                    <View style={s.reviewHeader}>
                      ...
                      <View style={s.reviewerInfo}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                          ...
                          {(item.verified || item.verifiedClient) && <ShieldCheck size={14} color="#10B981" style={{ marginLeft: 4 }} />}
                        </View>
                        <View style={s.starsRow}>
                          {[1, 2, 3, 4, 5].map((star) => (
...
const s = StyleSheet.create({
  ...
  featuredBadge: { alignSelf: 'flex-start', backgroundColor: 'rgba(245,158,11,0.2)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(245,158,11,0.4)' },
  featuredText: { color: '#FDE68A', fontSize: 11, fontWeight: '900', letterSpacing: 1 },
